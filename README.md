...
I design, build, and automate scalable cloud solutions using:  

- ☁️ **Azure** (AKS, Functions, App Services, Networking)  
- 🔧 **DevOps** (CI/CD, IaC, GitHub Actions, Azure DevOps)  
- 📦 **Containers & Orchestration** (Docker, Kubernetes)  
- 🛡 **Security & Reliability** (Identity, Monitoring, Governance)  

I’m passionate about automation, cloud-native architectures, and enabling teams to ship faster with confidence.  
